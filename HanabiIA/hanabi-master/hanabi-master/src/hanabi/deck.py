...
class Game:
    ...
    def __init__(self, players=5, multi=False):
        ...
        self.actions = {
            ...
            '?': (lambda x: self.log(ai.HatGuessIA(self).play()))
        }

        self.move = []
        self.ScoreHands = [None,None,None,None,None]
        self.ScoreDicoHands = {"Alice":None,"Benji":None, "Clara":None, "Dante":None, "Elric":None}

        self.FiveHands = []

        self.PlayableCards = [None]
        self.SmallestPlayable = [None]
        self.CartesJetees = [None]
        self.Indispensables = [None]
        
        self.ScoreTot = []
        self.ScoreTotMod8 = []

        self.Indices=[]
        self.MoveSinceLast=0
        self.PlaySinceLast = 0
    ...
    def reset(self, players=5, multi=False, cards=None):
        "Reset this game."
